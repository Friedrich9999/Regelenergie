...
# !!! Main.UserApp is configured as an alias for Main.RegelEnergieBackend and you might encounter it in some tests
using Main.RegelEnergieBackend, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "RegelEnergieBackend tests" begin
  @includetests ARGS
end
